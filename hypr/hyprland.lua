...
-- so a fresh home flashed "Your config has errors" on first boot. probe the path
-- first; a file that exists but is torn or corrupt still degrades via pcall instead
-- of emergency mode, and ryoku doctor repairs it.
